...
namespace PhotoAlbumBLL.DTO
{
    public class NewUserDTO
    {
        ...
        [Required(ErrorMessage = "Confirmation field cannot be empty!")]
        [StringLength(100, MinimumLength = 6, ErrorMessage = "Confirmation field length should be between 6 and 100 characters!")]
        [Compare("Password", ErrorMessage = "Password and confirmation fields are not the same!")]
